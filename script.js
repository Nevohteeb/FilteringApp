...
function filterProperties() {
    const filteredProperties = properties.filter(property => {
        ...
        if (filterValue && !propertyLocation.includes(filterValue)) {
            ...
            // if propery location doesnt include the filter value return false
            return false
        }
        ...
        // If all conditons pass, include the proper in the filtered array
        return true;
    });
...
// Sort Results - sort by price - lowest to hgihest
